# Code source: https://github.com/brohrer/lodgepole/blob/master/lodgepole/image_tools.py
# About more proper conversions: https://e2eml.school/convert_rgb_to_grayscale.html
